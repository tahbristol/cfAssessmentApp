<cfcomponent >
	...
	<cffunction name="search" output="false"  >
		...
		<cfif isDefined("rc.address") and isDefined("rc.search")>
			...
			<cfif rc.search is "officials" and !StructKeyExists(deserializeJSON(rc.data), "error")>
				<cfset rc.officialsArray=application.model.cfApp.makeOfficialsStruct(rc.data)/>
			<cfelseif rc.search is "elections" and !StructKeyExists(deserializeJSON(rc.data), "error")>
